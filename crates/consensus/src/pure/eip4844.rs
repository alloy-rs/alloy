use crate::constants::eip4844::{
    BLOB_GASPRICE_UPDATE_FRACTION, BLOB_TX_MIN_BLOB_GASPRICE, TARGET_DATA_GAS_PER_BLOCK,
};
...
mod tests {
    use super::*;
    use crate::constants::eip4844::DATA_GAS_PER_BLOB;
