...
/// Identifier for an EIP8141 transaction.
pub const EIP8141_TX_TYPE_ID: u8 = 6;
...
pub trait Typed2718 {
    ...
    /// Returns true if the type is a EIP-8141 transaction.
    fn is_eip8141(&self) -> bool {
        self.ty() == EIP8141_TX_TYPE_ID
    }
}
