...
- [ens] Follow CCIP Read redirects during resolution ([#4185](https://github.com/alloy-rs/alloy/issues/4185))
- [ens] Migrate resolution to the Universal Resolver ([#4183](https://github.com/alloy-rs/alloy/issues/4183))
