...
- [json-rpc] Propagate key parse errors in PubSubItem deserializer ([#3818](https://github.com/alloy-rs/alloy/issues/3818))

### Features

- [json-rpc] Add RpcError::error_code ([#4172](https://github.com/alloy-rs/alloy/issues/4172))
