use crate::{BorrowedResponse, ErrorPayload};

/// The result of a JSON-RPC request.
pub type RpcResult<Payload, ErrData, Err> = Result<Result<Payload, ErrorPayload<ErrData>>, Err>;

/// The result of a JSON-RPC request. This alias is used primarily for
/// intermediate deserialization. Most users will not require it.
pub type BorrowedRpcResult<'a, Err> = Result<BorrowedResponse<'a>, Err>;
