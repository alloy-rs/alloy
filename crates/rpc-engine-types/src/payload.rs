...
mod tests {
    ...
    #[test]
    fn serde_roundtrip_execution_payload_envelope_v3_optimism() {
        // pulled from a geth response getPayloadV3 in hive tests, modified to add a mock parent beacon block root.
