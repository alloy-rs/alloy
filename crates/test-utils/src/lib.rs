...
/// let factory: Address = "0x1F98431c8aD98523631AE4a59f267346ea31F984".parse().unwrap();
...
/// let input = abi::encode(&[Token::Address(token0), Token::Address(token1), Token::Uint(fee)]);
///
