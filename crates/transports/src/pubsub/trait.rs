...
impl std::fmt::Debug for BoxPubSub {
...
impl Service<RequestPacket> for BoxPubSub {
    ...
    fn poll_ready(
        ...
        Service::<RequestPacket>::poll_ready(&mut self.inner, cx)
    }

    fn call(&mut self, req: RequestPacket) -> Self::Future {
        Service::<RequestPacket>::call(&mut self.inner, req)
    }
}
